resource "aws_lambda_function" "core-function" {
  function_name = var.lambda-core-function-name
...
resource "aws_lambda_function" "list-function" {
  function_name = var.lambda-list-function-name
...
resource "aws_lambda_function" "cleanup-function" {
  function_name = var.lambda-cleanup-function-name
...
resource "aws_lambda_function" "upload-function" {
  function_name = var.lambda-upload-function-name
