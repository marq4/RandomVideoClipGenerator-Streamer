...
# TODO: rename JSs. Should only have to update in ONE place.

resource "local_file" "version-js" {
...
resource "local_file" "generate-js" {
  filename = "../CloudService/JS/generate_playlist.js"
  content = <<-EOT
    // Do not edit this file. It is managed by Terraform.
    ${templatefile("../CloudService/JS/generate_playlist.js.tpl", {
  endpoint = aws_apigatewayv2_api.rvcgs-http-api.api_endpoint
})}
  EOT
}

resource "local_file" "list-js" {
  filename = "../CloudService/JS/loadSuggestedMusicVideoList.js"
  content = <<-EOT
    // Do not edit this file. It is managed by Terraform.
    ${templatefile("../CloudService/JS/loadSuggestedMusicVideoList.js.tpl", {
  endpoint = aws_apigatewayv2_api.rvcgs-http-api.api_endpoint
})}
  EOT
}

resource "local_file" "upload-js" {
  filename = "../CloudService/JS/upload_video_list.js"
  content = <<-EOT
    // Do not edit this file. It is managed by Terraform.
    ${templatefile("../CloudService/JS/upload_video_list.js.tpl", {
  endpoint = aws_apigatewayv2_api.rvcgs-http-api.api_endpoint
})}
  EOT
}

# TODO: we don't need to repeat that code 4 times...
